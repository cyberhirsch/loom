...
- Cable types are checked: players/expression emit **notes** (valid targets: expression, synth, kit); synth/kit/fx emit **signal** (valid targets: delay, reverb, out); lfo/tension emit **CV** (valid target: `player.density`).
